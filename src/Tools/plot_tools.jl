# Fuel tank
function plot_surface(tank::CryogenicFuelTank, n_secs=5, n_pts=10)
...
@recipe function tank_plot(tank::FuelTank, n_secs=5, n_circ=10)
    tank_pans = plot_surface(tank, n_secs, n_circ)
...
@recipe function tank_plot(tank::CryogenicFuelTank; n_secs=5, n_circ=10)
